export default class InputManager {
    ...
    keyPress(event) {
        switch (event.key) {
            case "d": case "D": this.player.controls.right = true; break
            case "a": case "A": this.player.controls.left = true; break
            case "w": case "W": this.player.controls.up = true; break
            case "s": case "S": this.player.controls.down = true; break
    ...
    keyUp(event) {
        switch (event.key) {
            case "d": case "D": this.player.controls.right = false; break
            case "a": case "A": this.player.controls.left = false; break
            case "w": case "W": this.player.controls.up = false; break
            case "s": case "S": this.player.controls.down = false; break
